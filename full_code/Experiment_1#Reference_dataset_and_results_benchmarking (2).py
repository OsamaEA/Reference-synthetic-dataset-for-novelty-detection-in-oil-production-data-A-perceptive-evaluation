...
df = pd.read_excel('.\.\inputs\original_UNISIM_dataset.xlsx', header = [0,1], index_col = [0], sheet_name = 'synthetic_data')
...
reference_dataset.to_excel('.\.\results\experiment_1\Reference_synthetic_dataset_for_novelty_detections.xlsx')
output_results.to_excel('.\.\results\experiment_1\Results_on_reference_synthetic_dataset_seed_42.xlsx')
...
df_results_100_generators.to_csv('.\.\results\experiment_1\df_results_100_generators.csv')
...
df_outlying_mean.to_excel('.\.\results\experiment_1\Benchmark_results_on_100_randomly_generated_datasets.xlsx')
...
# Saving figure
plt.savefig('.\.\results\experiment_1\Benchmark_performance_on_100_randomly_generated_datasets.png')